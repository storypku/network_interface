...
TEST(TCPInterface, testReadBEFloat)
{
  ...
  ASSERT_FLOAT_EQ(123.45670318603515625, AS::Network::read_be<float>(bytes, 0));
}
...
TEST(TCPInterface, testReadBEDouble)
{
  ...
  ASSERT_DOUBLE_EQ(123.4567, AS::Network::read_be<double>(bytes, 0));
}
...
TEST(TCPInterface, testReadLEFloat)
{
  ...
  ASSERT_FLOAT_EQ(123.45670318603515625, AS::Network::read_le<float>(bytes, 0));
}
...
TEST(TCPInterface, testReadLEDouble)
{
  ...
  ASSERT_DOUBLE_EQ(123.4567, AS::Network::read_le<double>(bytes, 0));
}
